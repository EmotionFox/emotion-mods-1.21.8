...
import fr.emotion.emomodore.item.LumeStone;
...
public class EmoItems {
    public static final DeferredRegister.Items ITEMS = DeferredRegister.createItems(EmoMain.MODID);
    ...
    }), 20, SoundEvents.ARMOR_EQUIP_GENERIC, 2.5F, 0.0F, ItemTags.REPAIRS_VIRIDIS_ARMOR, ResourceKey.create(EquipmentAssets.ROOT_ID, ResourceLocation.fromNamespaceAndPath(EmoMain.MODID, "viridis")));
    ...
    public static final DeferredItem<Item> LUME_STONE = ITEMS.registerItem("lume_stone", LumeStone::new);
