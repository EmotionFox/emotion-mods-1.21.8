...
public class BeetleModel extends EntityModel<BeetleRenderState> {
    ...
    public BeetleModel(ModelPart root) {
        ...
        root.getChild("body");
        root.getChild("rightFrontLeg");
        root.getChild("rightBackLeg");
        root.getChild("leftFrontLeg");
        root.getChild("leftBackLeg");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
