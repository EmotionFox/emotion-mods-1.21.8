...
public class PotModel extends Model {
    ...
    public final ModelPart content;

    public PotModel(ModelPart root) {
        super(root, RenderType::entityCutout);
        this.pot = root.getChild("pot");
        this.content = root.getChild("content");
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition content = partdefinition.addOrReplaceChild("content", CubeListBuilder.create().texOffs(0, 21).addBox(-4.0F, -9.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
